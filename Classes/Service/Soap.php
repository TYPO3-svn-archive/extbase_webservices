...
/**
 * A soap server for extbase based on nusoap_server
 *
 * @package ExtbaseWebservices
 * @subpackage Service\Soap
 * @version $ID:$
 * @api
 */
require_once(t3lib_extMgm::extPath('extbase_webservices') . 'Resources/Library/NuSoap/class.nusoap_base.php');

class Tx_ExtbaseWebservices_Service_Soap extends nusoap_base {
	/**
